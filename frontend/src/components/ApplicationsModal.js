      ...
      <div className="relative top-10 mx-auto p-5 border w-full max-w-4xl shadow-lg rounded-md bg-white">
        ...
        {applications.length > 0 ? (
            ...
            {applications.map((application) => (
              <div key={application.id} className="bg-gray-50 rounded-lg p-4 border">
                ...
                {application.reviewNotes && (
                  <div className="mb-3">
                    <p className="text-sm font-medium text-gray-700 mb-1">Değerlendirme Notu:</p>
                ...
                {application.status === 1 && ( // Pending applications
                  <div className="flex items-center space-x-2 pt-3 border-t border-gray-200">
                    ...
                    <button
                      onClick={() => handleReviewApplication(application.id, 1)}
          ...
          <div className="text-center py-12">
            ...
            <p className="mt-2 text-gray-500">Bu projeye henüz kimse başvurmamış.</p>
          </div>
        )}
      ...
      <div className="relative top-20 mx-auto p-5 border w-full max-w-lg shadow-lg rounded-md bg-white">
        ...
        <div className="mb-4">
          <p className="text-sm text-gray-600">
            <strong>{application.studentName}</strong> tarafından yapılan başvuruyu değerlendirin.
          </p>
        </div>
